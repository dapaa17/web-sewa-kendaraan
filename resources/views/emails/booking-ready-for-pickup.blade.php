...
<body>
    <div class="container">
        <div class="header">
            <h1>Unit Anda Sudah Siap</h1>
            <div class="badge">SIAP DIGUNAKAN</div>
        </div>

        <p>Halo {{ $booking->user->name }},</p>
        <p>Kendaraan untuk booking Anda sekarang sudah siap digunakan. Unit sebelumnya sudah dikembalikan, jadi booking Anda sudah bisa diproses seperti biasa.</p>
        ...
        <div class="notice">
            ...
            <div>Silakan buka detail booking dan koordinasikan pengambilan kendaraan dengan admin agar proses serah terima lebih cepat.</div>
        </div>
