...
<div class="vf-header">
    <div class="container">
        <div class="vf-shell">
            ...
            <h1><i class="bi bi-plus-circle me-2" style="font-size:1.5rem"></i>Tambah Kendaraan</h1>
            <p class="subtitle mb-0">Tambahkan kendaraan baru ke dalam armada rental Anda</p>
        </div>
    </div>
</div>
                    ...
                    <form method="POST" action="{{ route('admin.vehicles.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="vf-group">
                            ...
                            <label class="vf-upload-zone" for="image">
                                ...
                                <span>Klik untuk upload foto — JPG, PNG, WEBP maks 5MB</span>
                            </label>
                        ...
                        <div class="vf-row">
                            <div class="vf-group">
                                ...
                                <input type="text" class="vf-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="contoh: Toyota Avanza" required>
                        ...
                        <div class="vf-row">
                            <div class="vf-group">
                                ...
                                <input type="number" class="vf-control @error('year') is-invalid @enderror" id="year" name="year" value="{{ old('year') }}" placeholder="contoh: 2024" required>
                            ...
                            <div class="vf-group">
                                ...
                                <input type="number" class="vf-control @error('daily_price') is-invalid @enderror" id="daily_price" name="daily_price" value="{{ old('daily_price') }}" placeholder="contoh: 350000" step="0.01" required>
                        ...
                        <div class="vf-row">
                            <div class="vf-group">
                                ...
                                <input type="number" class="vf-control @error('weekend_multiplier') is-invalid @enderror" id="weekend_multiplier" name="weekend_multiplier" value="{{ old('weekend_multiplier', '1.20') }}" step="0.01" min="1">
                                <div class="vf-hint">Dipakai untuk Jumat-Minggu.</div>
                            ...
                            <div class="vf-group">
                                ...
                                <input type="number" class="vf-control @error('peak_season_multiplier') is-invalid @enderror" id="peak_season_multiplier" name="peak_season_multiplier" value="{{ old('peak_season_multiplier', '1.40') }}" step="0.01" min="1">
                                <div class="vf-hint">Default dipakai untuk Desember dan Januari.</div>
                        ...
                        <div class="vf-row">
                            <div class="vf-group">
                                ...
                                <input type="number" class="vf-control @error('low_season_multiplier') is-invalid @enderror" id="low_season_multiplier" name="low_season_multiplier" value="{{ old('low_season_multiplier', '0.80') }}" step="0.01" min="0.10">
                                <div class="vf-hint">Default dipakai untuk Juli dan Agustus.</div>
                            ...
                            <div class="vf-group">
                                ...
                                <div class="vf-hint">Harga dasar tetap disimpan per hari, lalu multiplier dan aturan promo harian akan dipakai oleh kalender availability.</div>
                            </div>
                        </div>
                        ...
                        <div class="vf-group">
                            ...
                            <textarea class="vf-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" placeholder="Deskripsi singkat tentang kendaraan…">{{ old('description') }}</textarea>
                            @error('description')<div class="text-danger" style="font-size:.8rem;margin-top:.35rem">{{ $message }}</div>@enderror
                        </div>

                        <button type="submit" class="vf-submit"><i class="bi bi-check-lg"></i> Simpan Kendaraan</button>
